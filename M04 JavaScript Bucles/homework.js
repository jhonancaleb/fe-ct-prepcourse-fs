...
function colors(color) {
   ...
   else if (color === 'red') return 'This is ' + color
   else if (color === 'green') return 'This is ' + color
   else if (color === 'orange') return 'This is ' + color
...
function esPrimo(num) {
   ...
   // Tu código:
   // Comprobamos q sea mayor a 1, xq nums menores o iguales a 1 no son primos
   if (num <= 1) {
      return false;
   }
